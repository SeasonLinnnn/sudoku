...
namespace UnitTest1
{
	...
	public:
		...
		TEST_METHOD(TestMethod6)
		{
			...
			Assert::AreEqual(sudo.is_unique(0, 0, 1,2, matrix),false);
		}
		TEST_METHOD(TestMethod7)
		{
			...
			Assert::AreEqual(sudo.is_unique(0, 0, 1, 6, matrix), false);
		}
		TEST_METHOD(TestMethod8)
		{
			...
			Assert::AreEqual(sudo.is_unique(0, 0, 1, 7, matrix), false);
		}
		TEST_METHOD(TestMethod9)
		{
			...
			Assert::AreEqual(sudo.is_unique(0, 0, 1, 8, matrix), false);
		}
		TEST_METHOD(TestMethod10)
		{
			...
			Assert::AreEqual(sudo.is_unique(0, 8, 0, 7, matrix), true);
		}
